...
$BASE_FIELD = array('initiator_id','type','tour_line','title','photo','content','price','count','days');

$response_sql = "select initiator_id, type, tour_line, title, photo, content, price, count, days from goods where id = $id";
